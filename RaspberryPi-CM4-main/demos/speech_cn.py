...
def actions_dog(act):
    ...
    if mark:
        ...
        lcd_draw_string(
            draw, 60, 70, "错误命令词，请再次尝试", color=(255, 0, 0), scale=font3, mono_space=False
        )
