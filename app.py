...
status=0
cmd=b''
order='python3 printtest.py'
pi= subprocess.Popen(order,shell=True,universal_newlines=True,stdin=subprocess.PIPE,stdout=subprocess.PIPE)
mark=True
running=True
status=0
exitcode=False
...
print('aiblocks over')
os.system('sudo fuser -k -n tcp 6000')
