...
def start_recording(timel=3, save_file="recorded_audio.wav"):
    ...
    if automark:
        ...
        libpath = "/home/pi/RaspberryPi-CM4-main/demos/speechCn/src/libnyumaya_premium.so.3.1.0"
        extractor = FeatureExtractor(libpath)
        detector = AudioRecognition(libpath)
        extactor_gain = 1.0
        keywordIdlulu = detector.addModel("/home/pi/RaspberryPi-CM4-main/demos/speechCn/src/lulu_v3.1.907.premium", 0.7)
        ...
        while not break_luyin:
            ...
            if prediction == keywordIdlulu:
                ...
                os.system("aplay /home/pi/RaspberryPi-CM4-main/demos/speechCn/voice/ding.wav")
                break
